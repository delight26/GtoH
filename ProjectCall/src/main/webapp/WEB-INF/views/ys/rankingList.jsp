...
onClick="window.open(this.href, '', 'width=400, height=430'); return false;">쪽지보기</a>
	<table>
		...
		<c:choose>
<c:when test="${l.name =='관리자' }"> </c:when>
<c:otherwise>
			<tr>
			<th><img src="http://placehold.it/70x70"></th>
			<th>${l.level }</th>
			<th><a href="YSAddNoteForm?email=${l.email }&nickName=${l.nickName}" onClick="window.open(this.href, '', 'width=400, height=430'); return false;">${l.nickName }</a></th>
