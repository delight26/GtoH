...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/freecontent.js"></script>
...
<body>
	...
	<div>
		...
		<c:if test="${loginUser.email == frbEmail || loginUser.nickName == nickName}">
			 <a href="freeupdate?frbNo=${frb.frbNo }" data-toggle="modal" data-target="#myModal"><img src="resources/images/btn_modify.gif" width="50px" style="border-radius: 4px;"/></a>
			 <a href="javascript:freedelete(${frb.frbNo })"><img src="resources/images/btn_delete.gif" width="50px" style="border-radius: 4px;"/></a>
		</c:if>
		<div style="float: right;">
			<a href="freepre?frbNo=${frb.frbNo }&pageNum=${pageNum }"><img src="resources/images/btn_pre.jpg" width="70px" style="border-radius: 4px;"/></a>
			<a href="freenext?frbNo=${frb.frbNo }&pageNum=${pageNum }"><img src="resources/images/btn_next.jpg" width="70px" style="border-radius: 4px;"/></a>
			<a href="freeboard?pageNum=${pageNum }"><img src="resources/images/btn_list.gif" width="70px" style="border-radius: 4px;"/></a>
		</div>
	</div>
<div id="comment">
</div>
