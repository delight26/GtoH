	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<a href="aggrowrite" data-toggle="modal" data-target="#myModal"
				...
				<div style="float: right">
					<input type="text" id="search" name="search" /> <a
						href="javascript:search()"><img src="resources/images/btn_search.jpg" width="50px" style="border-radius: 4px;"/></a>
				</div>
