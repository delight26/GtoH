...
<title>Call : 회원가입 </title>
<!-- <link href="/TeamProject_ver5.0_final/css/join.css" type="text/css" rel="stylesheet">
<link href="/TeamProject_ver5.0_final/css/join_pc.css" type="text/css" rel="stylesheet">
 -->
<link rel="stylesheet" href="../../resources/css/join_pc.css" />
<link rel="stylesheet" href="../../resources/css/join.css" />
<script src="../../resources/js/clickcr.js"></script>
<script src="../../resources/js/join_kr.js"></script>
...
<!-- 	<fieldset> -->	
	...
	<div id="container">
		...
		<div id="content">
			<h2 class="blind">Call 약관 동의</h2>
			<div class="join_content">
			
<form name="join_form" method="post" action="step2" >
	<input type="hidden" id="token_sjoin" name="token_sjoin" value="n9uVbI0t1KM6tVu2">
		
				<!-- 약관동의 -->
				<div class="terms_p" style="width: 700px; height: 500px;">
...
<div class="article">
								...
								<p class="article__text">이 약관은 ProjectCall Team이 제공하는 ProjectCall 및 ProjectCall 관련 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
							</div>
							<div class="article">
								<h3 class="article__title">제 2 조 (정의)</h3>
								<p class="article__text">이 약관에서 사용하는 용어의 정의는 다음과 같습니다.</p>
								<ol class="sections">
									<li class="sections__section">①"서비스"라 함은 구현되는 단말기(PC, TV, 휴대형단말기 등의 각종 유무선 장치를 포함)와 상관없이 "회원"이 이용할 수 있는 ProjectCall 및 ProjectCall 관련 제반 서비스를 의미합니다.</li>
						...
						<li class="terms_bx terms_privacy">
								<label id="termsPrivacyLb" for="termsPrivacy"> 개인정보 수집 및 이용에 대한 안내</label>
							<div class="terms_box">								
								<!-- 개인정보 수집 및 이용에 대한 안내 -->
<div class="policy_summary">
								<p class="policy_summary__text">정보통신망법 규정에 따라 ProjectCall에 회원가입 신청하시는 분께 수집하는 개인정보의 항목, 개인정보의 수집 및 이용목적, 개인정보의 보유 및 이용기간을 안내 드리오니 자세히 읽은 후 동의하여 주시기 바랍니다.</p>
							</div>
							<div class="article">
								<h3 class="article__title">1. 수집하는 개인정보</h3>
								<p class="article__text">이용자는 회원가입을 하지 않아도 정보 검색, 뉴스 보기 등 대부분의 ProjectCall 서비스를 회원과 동일하게 이용할 수 있습니다. 이용자가 메일, 캘린더, 카페, 블로그 등과 같이 개인화 혹은 회원제 서비스를 이용하기 위해 회원가입을 할 경우, ProjectCall는 서비스 이용을 위해 필요한 최소한의 개인정보를 수집합니다.</p>
								<div class="clause">
									<h4 class="clause__title">회원가입 시점에 ProjectCall가 이용자로부터 수집하는 개인정보는 아래와 같습니다.</h4>
									<ul class="sections">
										<li class="sections__section">- 회원 가입 시에 ‘아이디, 비밀번호, 이름, 생년월일, 성별, 가입인증 휴대폰번호’를 필수항목으로 수집합니다. 만약 이용자가 입력하는 생년월일이 만14세 미만 아동일 경우에는 법정대리인 정보를 추가로 수집합니다. 그리고 선택항목으로 이메일 주소를 수집합니다.</li>
										<li class="sections__section">- 단체아이디로 회원 가입 시에 단체아이디, 단체이름, 법인명(단체명), 대표자명, 대표 전화번호, 사업장소재지, 관리자 아이디, 관리자 휴대폰번호를 필수항목으로 수집합니다.</li>
									</ul>
									...
									<p class="clause__text">구체적으로 1) 서비스 이용 과정에서 이용자에 관한 정보를 정보통신서비스 제공자가 자동화된 방법으로 생성하여 이를 저장(수집)하거나, 2) 이용자 기기의 고유한 정보를 원래의 값을 확인하지 못하도록 안전하게 변환한 후에 수집하는 경우를 의미합니다.</p>
								</div>
							</div>
							<div class="article">
								<h3 class="article__title">2. 수집한 개인정보의 이용</h3>
								<p class="article__text">ProjectCall는 회원관리, 서비스 개발・제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.</p>
								<ul class="sections">
									...
									<li class="sections__section">- 법령 및 ProjectCall 이용약관을 위반하는 회원에 대한 이용 제한 조치, 부정 이용 행위를 포함하여 서비스의 원활한 운영에 지장을 주는 행위에 대한 방지 및 제재, 계정도용 및 부정거래 방지, 약관 개정 등의 고지사항 전달, 분쟁조정을 위한 기록 보존, 민원처리 등 이용자 보호 및 서비스 운영을 위하여 개인정보를 이용합니다.</li>
							...
							<div class="article">
								...
								<div class="clause">
									...
									<p class="clause__text">부정가입 및 징계기록 등의 부정이용기록은 부정 가입 및 이용 방지를 위하여 수집 시점으로부터 6개월간 보관하고 파기하고 있습니다. 부정이용기록 내 개인정보는 가입인증 휴대폰 번호(만 14세 미만 회원의 경우 법정대리인 DI)가 있습니다.<br>결제도용, 카드깡 등 관련 법령 및 이용약관을 위반하는 ProjectCall페이의 부정거래기록(아이디, 이름, 휴대폰번호, 배송지 주소, IP주소, 쿠키, 기기정보)은 부정거래 방지 및 다른 선량한 이용자의 보호, 안전한 거래 환경 보장을 위하여 수집 시점으로부터 3년간 보관하고 파기합니다.</p>
								</div>
								<div class="clause">
									<h4 class="clause__title">전자상거래 등에서의 소비자 보호에 관한 법률, 전자금융거래법, 통신비밀보호법 등 법령에서 일정기간 정보의 보관을 규정하는 경우는 아래와 같습니다. ProjectCall는 이 기간 동안 법령의 규정에 따라 개인정보를 보관하며, 본 정보를 다른 목적으로는 절대 이용하지 않습니다.</h4>
									<ul class="sections">
					...
					<span id="termsMsg" class="error" style="display:none"> project 이용약관과 개인정보 수집 및 이용에 대한 안내 모두 동의해주세요. </span>
				</div>			
				<a name="bottom"></a>
				<div class="btn_group">
					<a href="#" onClick="submitAgree();clickcr(this, 'tos.agree', '', '', event);" class="btn_agree"><span class="blind">동의</span></a> 
					<span class="btn_cell">.</span>
					<a href="#" onClick="submitDisagree();clickcr(this, 'tos.disagree', '', '', event);" class="btn_cancel"><span class="blind">취소</span></a>
				</div>
